...
public class DetergentContainer implements CheckAbleComponent {
    ...
    private int fabricSoftenerContainerInMilliliters;
    private int laundryDetergentContainerInMilliliters;
    ...
    public void setDefaultValue() {
        ...
        this.fabricSoftenerContainerInMilliliters = 0;
        this.laundryDetergentContainerInMilliliters = 0;
    }
}
