...
public class WashingMachineModes {
    ...
    public static final int waterToPumpInLiters = 1;

    public static final WashingMachineModes DEFAULT = new WashingMachineModes(90, 5, 15, true, 1200);
    ...
    private static void validateSetting(PermissionValuesForModes validateModeSettings, int actualValue) {
        if (validateModeSettings.isValueOutOfRange(actualValue)) {
